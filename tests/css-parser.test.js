...
test("border-radius(shorthand)", () => {
  ...
  expect(rule1.getPropertyValue("border-before-start", "1 5"));
  expect(rule1.getPropertyValue("border-before-end", "2 6"));
  expect(rule1.getPropertyValue("border-after-end", "3 7"));
  expect(rule1.getPropertyValue("border-after-start", "4 8"));

  let rule2 = Nehan.CssParser.parseRule("*", {
    "border-radius":"1 2 3 4/5"
  })[0];
  expect(rule2.getPropertyValue("border-before-start", "1 5"));
  expect(rule2.getPropertyValue("border-before-end", "2 5"));
  expect(rule2.getPropertyValue("border-after-end", "3 5"));
  expect(rule2.getPropertyValue("border-after-start", "4 5"));

  let rule3 = Nehan.CssParser.parseRule("*", {
    "border-radius":"1 2 3 4/5 6"
  })[0];
  expect(rule3.getPropertyValue("border-before-start", "1 5"));
  expect(rule3.getPropertyValue("border-before-end", "2 6"));
  expect(rule3.getPropertyValue("border-after-end", "3 5"));
  expect(rule3.getPropertyValue("border-after-start", "4 6"));

  let rule4 = Nehan.CssParser.parseRule("*", {
    "border-radius":"1 2 3 4/5 6 7"
  })[0];
  expect(rule4.getPropertyValue("border-before-start", "1 5"));
  expect(rule4.getPropertyValue("border-before-end", "2 6"));
  expect(rule4.getPropertyValue("border-after-end", "3 6"));
  expect(rule4.getPropertyValue("border-after-start", "4 7"));

  let rule5 = Nehan.CssParser.parseRule("*", {
    "border-radius":"1 2 3 4"
  })[0];
  expect(rule5.getPropertyValue("border-before-start", "1 1"));
  expect(rule5.getPropertyValue("border-before-end", "2 2"));
  expect(rule5.getPropertyValue("border-after-end", "3 3"));
  expect(rule5.getPropertyValue("border-after-start", "4 4"));

  let rule6 = Nehan.CssParser.parseRule("*", {
    "border-radius":"1 2 3"
  })[0];
  expect(rule6.getPropertyValue("border-before-start", "1 1"));
  expect(rule6.getPropertyValue("border-before-end", "2 2"));
  expect(rule6.getPropertyValue("border-after-end", "2 2"));
  expect(rule6.getPropertyValue("border-after-start", "3 3"));

  let rule7 = Nehan.CssParser.parseRule("*", {
    "border-radius":"1 2"
  })[0];
  expect(rule7.getPropertyValue("border-before-start", "1 1"));
  expect(rule7.getPropertyValue("border-before-end", "2 2"));
  expect(rule7.getPropertyValue("border-after-end", "1 1"));
  expect(rule7.getPropertyValue("border-after-start", "2 2"));

  let rule8 = Nehan.CssParser.parseRule("*", {
    "border-radius":"1"
  })[0];
  expect(rule8.getPropertyValue("border-before-start", "1 1"));
  expect(rule8.getPropertyValue("border-before-end", "1 1"));
  expect(rule8.getPropertyValue("border-after-end", "1 1"));
  expect(rule8.getPropertyValue("border-after-start", "1 1"));
});
