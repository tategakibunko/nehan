      ...
      while (true) {
        ...
        if (value.type === 'line-break') {
          ...
          if (isPageRoot) {
            ...
            //
            // [some-block][br]
            // [page-break][br] <-- empty-line generated by [br]!
            // [some-large-img] <-- page-break-before(too large extent)
            //
            // In this pattern, empty-line is generated by [br] before [some-large-img]
            // and [page-break] is also generated before [some-large-img].
