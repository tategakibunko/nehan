      ...
      while (true) {
        ...
        this.context.suspendedGens = this.context.suspendedGens.filter(generator => {
          ...
          if (fvalue.type === "block") {
            ...
            this.context.flowRoot.addFloat(fvalue.body, float, this.context.maxMeasure, this.context.flowRootPos.before, this.context.contextBoxEdge.padding.getSize("start"));
          }
          return true;
        });
        ...
        if (!float.isNone() && value.isFloatable) {
          this.context.flowRoot.addFloat(value.body, float, this.context.maxMeasure, this.context.flowRootPos.before, this.context.contextBoxEdge.padding.getSize("start"));
