...
export class LogicalTextNode implements ILogicalNode {
  constructor(
    ...
    public text: string,
    // Note that `indent` flag is true when this text-node is generated by inline-overflow.
    // If indent flag is true, text-node-generator generate text-node and then generate lineBreak(LayoutResult).
    // This flag is used to skip <br> tag that will follow just after this lineBreak.
